...
According to the result (Figure 4) **p-value** for all manufacturing lots is 0.5117, for lot 1 = 1.00, for lot 2 = .60, and for lot 3 = 0.04. In only 2 cases **p-value** is above the assumed significance level of 0.05. 
